using GeradorSenhas.Data;
using GeradorSenhas.Interfaces;
using GeradorSenhas.Models;
using GeradorSenhas.Models.DTOs;
//using GeradorSenhas.Models.DTOs.AlterarSenhaDTO;
//using GeradorSenhas.Models.DTOs.LoginDTO;
//using GeradorSenhas.Models.DTOs.RegistrarDTO;
using GeradorSenhas.Services;
